/**
 * Vanilla pi bash tool — copied from @earendil-works/pi-coding-agent v0.78.0
 * dist/core/tools/bash.js
 *
 * This is the unmodified reference implementation. We commit it so we can
 * diff against our modifications later, and revert if needed.
 *
 * Original source:
 *   ~/.nvm/versions/node/v24.14.1/lib/node_modules/@earendil-works/pi-coding-agent/dist/core/tools/bash.js
 */
